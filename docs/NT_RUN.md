...
Сервис слушает только `127.0.0.1`. Описанная схема рассчитана на backend и runner на одном хосте; адрес loopback внутри отдельного контейнера указывает на сам контейнер. Управляющие запросы требуют того же bearer-токена,
